...
export const metadata: Metadata = {
  title: "Pricing — Rbi Grade B Premium",
  description: "Unlock unlimited Rbi Grade B practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=rbi-grade-b&cadence=annual`;
